...
?>
    ...
    <body>
        ...
        ?>
            <section class="container-fluid" id="fundogeralInicial">

                <header class="row" id="cabecalho-menu">
                    <nav class="col-12 navbar navbar-expand-md navbar-dark m-0 pl-3 pr-3">
                        <a class="navbar-brand h1 mb-0" href="index.php">
                            <small><i class="fa fa-home"></i></small></i> Inicio
                        </a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarsite">
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item">
                                    <a class="nav-link d-block d-sm-none" href="includes/paginas/galeria/index.html">
                                        <i></i>Galeria
                                    </a>
                                </li>
                                <?php
            ...
            <article class="container-fluid pt-2" id="chmaratencao">
            ...
            <footer id="footer" class="row m-0 ">
                ...
                <div class="col-4 ">
                    <a href="https://api.whatsapp.com/send?1=pt_BR&phone=551899665-2579" target="_blank">
                        <center><img src="includes/img/whatsapp.png" class="orgIcon" title="Wharsapp" /></center>
                    </a>
                </div>
                <div class="col-4">
                    <a href="https://www.facebook.com/ACNfest-1345351735555388/" target="_blank">
                        <center><img src="includes/img/facebook.png" class="orgIcon" title="Facebook" /></center>
                    </a>
                </div>
                <div class="col-4">
                    <a href="https://www.instagram.com/acn_fest/?hl=pt-br" target="_blank">
                        <center><img src="includes/img/instagram.png" class="orgIcon" title="Instagram" /></center>
                    </a>
                </div>
